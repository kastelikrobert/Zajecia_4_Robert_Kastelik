...
#define TARGA_UNCOMP_BW_IMG 0x03
 ...
 // fiWHITE_SKIN_MAN_FACEme - nazwa pliku
 ...
 // pixels - wskaźnik na tablicę z danymi obrazu
	...
	GLboolean load_targa(const char *fiWHITE_SKIN_MAN_FACEme, GLsizei &width, GLsizei &height,
		GLenum &format, GLenum &type, GLvoid *&pixels)
{
	...
	FILE *tga = fopen(fiWHITE_SKIN_MAN_FACEme, "rb");
...
GLboolean save_targa(const char *fiWHITE_SKIN_MAN_FACEme, GLsizei width, GLsizei height,
	GLenum format, GLenum type, GLvoid *pixels)

{
	...
	FILE *tga = fopen(fiWHITE_SKIN_MAN_FACEme, "wb");
