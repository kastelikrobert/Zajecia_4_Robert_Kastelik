...

{
	...
	TEXTURE_WHITE_SKIN_MAN_FACE,                    // tekstura WHITE_SKIN_MAN_FACE

	TEXTURE_WHITE_SKIN_MAN_FACE_UNC,                // teksura WHITE_SKIN_MAN_FACE nieskompresowana

	TEXTURE_WHITE_SKIN_MAN_FACE_GRAY,               // tekstura WHITE_SKIN_MAN_FACE_gray

	TEXTURE_WHITE_SKIN_MAN_FACE_GRAY_UNC,           // tekstura WHITE_SKIN_MAN_FACE_gray nieskompresowana
...
GLuint WHITE_SKIN_MAN_FACE, WHITE_SKIN_MAN_FACE_UNC, WHITE_SKIN_MAN_FACE_GRAY, WHITE_SKIN_MAN_FACE_GRAY_UNC;
...

{
	...
	GLboolean error = load_targa("skin.tga", width, height, format, type, pixels);
	...
	glGenTextures(1, &WHITE_SKIN_MAN_FACE);


	// dowiązanie stanu tekstury

	glBindTexture(GL_TEXTURE_2D, WHITE_SKIN_MAN_FACE);
	...
	glGenTextures(1, &WHITE_SKIN_MAN_FACE_UNC);


	// dowiązanie stanu tekstury

	glBindTexture(GL_TEXTURE_2D, WHITE_SKIN_MAN_FACE_UNC);
	...
	error = load_targa("skin.tga", width, height, format, type, pixels);
	...
	glGenTextures(1, &WHITE_SKIN_MAN_FACE_GRAY);


	// dowiązanie stanu tekstury

	glBindTexture(GL_TEXTURE_2D, WHITE_SKIN_MAN_FACE_GRAY);
	...
	glGenTextures(1, &WHITE_SKIN_MAN_FACE_GRAY_UNC);


	// dowiązanie stanu tekstury

	glBindTexture(GL_TEXTURE_2D, WHITE_SKIN_MAN_FACE_GRAY_UNC);
...

{
	...
	case TEXTURE_WHITE_SKIN_MAN_FACE:
	...
	// teksura WHITE_SKIN_MAN_FACE nieskompresowana

	case TEXTURE_WHITE_SKIN_MAN_FACE_UNC:

	{

		texture = WHITE_SKIN_MAN_FACE_UNC;
	...
	// tekstura WHITE_SKIN_MAN_FACE_gray

	case TEXTURE_WHITE_SKIN_MAN_FACE_GRAY:

	{

		texture = WHITE_SKIN_MAN_FACE_GRAY;
	...
	// tekstura WHITE_SKIN_MAN_FACE_gray nieskompresowana

	case TEXTURE_WHITE_SKIN_MAN_FACE_GRAY_UNC:

	{

		texture = WHITE_SKIN_MAN_FACE_GRAY_UNC;
...

{
	...
	glutAddMenuEntry("skin.tga (kompresja)", TEXTURE_WHITE_SKIN_MAN_FACE);

	glutAddMenuEntry("skin.tga (bez kompresji)", TEXTURE_WHITE_SKIN_MAN_FACE_UNC);

	glutAddMenuEntry("skin.tgaa (kompresja)", TEXTURE_WHITE_SKIN_MAN_FACE_GRAY);

	glutAddMenuEntry("skin.tga (bez kompresji)", TEXTURE_WHITE_SKIN_MAN_FACE_GRAY_UNC);
