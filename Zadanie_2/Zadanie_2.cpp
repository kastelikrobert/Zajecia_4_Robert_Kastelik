//Robert Kastelik
//n=7
//pine_tree_big_20150403_2028379675
...

{
	...
	error = load_targa("tree.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku tree.tga");
